...
export default () => {
  ...
  <Page>
    ...
    <Paragraph>I am an ever-developing web developer and graphic designer, and among other things I am currently developing <a href="https://curiouser.house/">Curiouser House Publishing</a> in my <Link to="/Book">spare</Link> time, redesigning and republishing classic literature in uniform editions. Throughout my time I have helped develop and design websites for several startups and small businesses, including <a href="https://www.tomthebookguy.com">Tom the Book Guy</a>, where I worked for nearly seven years. Hence the following little React app!</Paragraph>
